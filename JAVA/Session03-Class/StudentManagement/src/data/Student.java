...
public class Student {
    private static String id;   //nằm ở một vùng nhớ riêng mà obj nào cũng được xài ké,
                                //chung cho các obj cùng class
    public static String name;  //vùng nhớ xài chung cho các obj cùng nhóm/Class
...
//    }//hiếm khi đổi mã số, giống như môn Database primary key
    ...
    public static void sayHi(){
        System.out.println("Hi every one, my name is: " + name);
